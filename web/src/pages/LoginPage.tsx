    ...
    <div className="commerce-login min-h-screen overflow-y-auto">
      ...
      <header className="commerce-login-header relative z-10 flex items-center justify-between px-6 py-4 lg:px-12">
        ...
        <div className="flex items-center gap-2">
          <a
            href="https://github.com/sclfcz/commerceagent"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Button variant="ghost" size="sm" className="commerce-login-github">
      ...
      {/* ── Hero + Auth section ── */}
      <main className="commerce-login-main relative z-10 px-5 sm:px-6 lg:px-12 pt-4 pb-8 lg:pt-10 lg:pb-12 flex-1 flex items-start lg:items-center">
        <div className="mx-auto max-w-6xl w-full">
          <div className="commerce-login-grid flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
            ...
            {/* Right: Auth card */}
            <div className="commerce-login-form-wrap flex justify-center lg:justify-end w-full">
              <div className="commerce-login-card w-full max-w-sm">
                {/* Logo */}
