...
export function AppLayout() {
  ...
  useEffect(() => {
    const appName = appearance?.appName || 'CommerceAgent';
  ...
  return (
    <div
      data-ecommerce-shell="true"
      className="h-screen supports-[height:100dvh]:h-dvh flex flex-col lg:flex-row overflow-hidden safe-area-top"
    >
