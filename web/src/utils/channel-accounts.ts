...
export const CHANNEL_PROVIDER_OPTIONS: ChannelProviderOption[] = [
  {
    ...
    setupGuide: {
      ...
      nextStep:
        '发布后在飞书里给 Bot 发起私聊，CommerceAgent 会自动识别账号 Owner。',
    },
    supportsTest: true,
  ...
  },
  {
    ...
    setupGuide: {
      ...
      steps: [
        '填写账号名称，并在下一步选择默认工作区。',
        '点击“创建并扫码”，CommerceAgent 会生成微信登录二维码。',
        '用手机微信扫码确认；如微信要求验证码，直接在 CommerceAgent 中输入。',
      ],
      nextStep:
  ...
  },
  {
    ...
    setupGuide: {
      ...
      steps: [
        '填写账号名称，并在下一步选择默认工作区。',
        '点击“创建并扫码”，等待 CommerceAgent 生成关联设备二维码。',
