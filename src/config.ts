...
export const ASSISTANT_NAME = process.env.ASSISTANT_NAME || 'CommerceAgent';
...
export const SESSION_COOKIE_NAME_SECURE = '__Host-commerceagent_session';
export const SESSION_COOKIE_NAME_PLAIN = 'commerceagent_session';
