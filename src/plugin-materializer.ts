 ...
 *      marker = runtime/{userId}/snapshots/{snapshotId}/@commerceagent-runtime-markers/{mp}/{plugin}.json
 ...
 */
const MARKER_DIRNAME = '@commerceagent-runtime-markers';
...
/** runtime/{userId}/snapshots/{snapshotId}/@commerceagent-runtime-markers/{mp}/{plugin}.json */
