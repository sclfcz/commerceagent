/**
 * Shared types for CommerceAgent Agent Runner.
 *
...
/**
 * Sanitized, per-input-turn channel identity supplied by the CommerceAgent host.
 *
...
export function formatChannelTurnContextForPrompt(
  ...
  if (!context) return '';
  return [
    '<channel_context source="commerceagent_host" trust="verified">',
...
export interface ContainerInput {
   ...
   * effective top-level AgentProfile is the built-in main CommerceAgent. */
  ...
  /** Canonical effective Skill set resolved by the CommerceAgent host. */
